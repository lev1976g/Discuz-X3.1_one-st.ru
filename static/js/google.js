...
document.writeln('<option value="0"' + google_default_0 + '>Веб-поиск</option>');
document.writeln('<option value="1"' + google_default_1 + '>Поиск по сайту</option>');
document.writeln('</select>');
document.writeln('&nbsp;<button type="submit" name="sa" value="true">Найти</button>');
