...
drag.extend({
	...
	setSampleMenu : function () {
		...
		this.addMenu('block', 'Обновление', 'drag.blockForceUpdate(event)');
	},
	...
	init : function (sampleMode) {
		this.initCommon();
		$('samplepanel').innerHTML = 'Прямое управление модулем данных [<a href="javascript:;" onclick="spaceDiy.cancel();return false;" class="xi2">Выход</a>]';
	...
	blockForceUpdate : function (e,all) {
		...
		bcontent.innerHTML = '<center>Загрузка содержимого ...</center>';
		var x = new Ajax();
