...
(
	...
	'articlelist_keyword_comment' => 'Ключевые слова. Примечание: Оставьте пустым если не хотите использовать фильтрации. В ключевых словах можно использовать символы *, соответствующие одному или нескольким ключевым словам. Также могут быть использованы | или OR, как для  Win32, так и для UNIX',
);
