...
<p class="chart z">Сегодня: <em><?php echo $todayposts;?></em><span class="pipe">|</span>Вчера: <em><?php echo $postdata['0'];?></em><span class="pipe">|</span>Сообщений: <em><?php echo $posts;?></em><span class="pipe">|</span>Пользователи : <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em><?php if($_G['cache']['userstats']['newsetuser']) { ?><span class="pipe">|</span>Приветствуем новеньких: <em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank" class="xi2"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></em><?php } ?></p>
<div class="y">
...
<div class="bm_h cl">
<span class="o">
<img id="category_-1_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_-1'];?>" title="Открыть/Закрыть" alt="Открыть/Закрыть" onclick="toggle_collapse('category_-1');" />
</span>
...
<div class="bm_h cl">
<span class="o">
<img id="category_0_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_0'];?>" title="Открыть/Закрыть" alt="Открыть/Закрыть" onclick="toggle_collapse('category_0');" />
</span>
...
<div class="bm_h cl">
<span class="o">
<img id="category_-2_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_-2'];?>" title="Открыть/Закрыть" alt="Открыть/Закрыть" onclick="toggle_collapse('category_-2');" />
</span>
