...
foreach($post['numbercard'] as $numbercardkey => $numbercard) $return .= ($numbercardkey == 2 ? '<td>' : '<th>').$numbercard[lang].'<p><a href="'.$numbercard[link].'" class="xi2">'.dnumber($numbercard[value]).'</a></p>'.($numbercardkey == 2 ? '</td>' : '</th>');
?><?php
$return = <<<EOF
